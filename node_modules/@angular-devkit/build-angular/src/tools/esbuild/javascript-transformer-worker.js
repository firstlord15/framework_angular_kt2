"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\firstlord\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.304\\out\\buildHook\\index.js').default({tool: 'angular'}); } catch(cjsError) { try { import('file:///c:/Users/firstlord/.vscode/extensions/wallabyjs.console-ninja-1.0.304/out/buildHook/index.js').then(m => m.default.default({tool: 'angular'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
